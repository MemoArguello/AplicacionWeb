...
<div class="container-fluid">
    <div class="container-fluid form-neon">
        <div class="container-fluid">
            <h2 align="center">Seccion de Venta</h2><br>
            ...
            <p class="text-center">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalCliente"><i
                        class="ti-user"></i> &nbsp; Agregar cliente</button>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalItem"><i
                        class="ti-package"></i> &nbsp; Agregar Producto</button>
            </p>
            <br>
            <div>
                <span class="roboto-medium">CLIENTE:</span>
                <span class="text-danger">&nbsp; <i class="ti-user"></i> Seleccione un
                    cliente</span>
                <form action="" style="display: inline-block !important;">
                    Carlos Alfaro
                    <button type="button" class="btn btn-danger"><i class="ti-close"></i></button>
                </form>
            </div>
            <br>
        ...
        <form action="" autocomplete="off">
            ...
            <fieldset>
            -->
                <legend><i class="ti-wallet"></i> &nbsp; Pago</legend>
                <div class="container-fluid">
                    <div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><i class="ti-search"></i> &nbsp; Buscar</button>
                &nbsp; &nbsp;
